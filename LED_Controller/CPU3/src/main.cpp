...
SerialPortMessageManager m_CPU1SerialPortMessageManager = SerialPortMessageManager("CPU1", &Serial1, &m_DataSerializer, tskNO_AFFINITY, THREAD_PRIORITY_HIGH);
SerialPortMessageManager m_CPU2SerialPortMessageManager = SerialPortMessageManager("CPU2", &Serial2, &m_DataSerializer, tskNO_AFFINITY, THREAD_PRIORITY_HIGH);
