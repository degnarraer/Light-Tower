...
#define SEMAPHORE_NO_BLOCK pdMS_TO_TICKS(0)
#define SEMAPHORE_SHORT_BLOCK pdMS_TO_TICKS(1)
#define SEMAPHORE_MEDIUM_BLOCK pdMS_TO_TICKS(10)
#define SEMAPHORE_LONG_BLOCK pdMS_TO_TICKS(100)
#define SEMAPHORE_BLOCK portMAX_DELAY
