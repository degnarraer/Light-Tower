...
{  
  ...
  private:
    ...
    LocalStringDataItemWithPreferences m_SSID = LocalStringDataItemWithPreferences( "SSID"
                                                                                  ...
                                                                                  , &m_SSID_Callback
                                                                                  , this );
    WebSocket_String_DataHandler m_SSID_DataHandler = WebSocket_String_DataHandler( "SSID Web Socket Handler", m_WebSocketDataProcessor, true, true, m_SSID, false );
    ...
    LocalStringDataItemWithPreferences m_Password = LocalStringDataItemWithPreferences( "Password"
                                                                                      ...
                                                                                      , &m_Password_Callback
                                                                                      , this );
    WebSocket_String_DataHandler m_Password_DataHandler = WebSocket_String_DataHandler( "Password Web Socket Handler", m_WebSocketDataProcessor, true, true, m_Password, false );
    ...
    WebSocketDataHandler<bool, 1> m_BluetoothSinkEnable_DataHandler = WebSocketDataHandler<bool, 1>( "Sink Enable Web Socket Handler", m_WebSocketDataProcessor, true, true, m_BluetoothSinkEnable, false );
    ...
    WebSocket_String_DataHandler m_SinkName_DataHandler = WebSocket_String_DataHandler( "Sink Name Web Socket Handler", m_WebSocketDataProcessor, true, true, m_SinkName, false );
    ...
    WebSocket_String_DataHandler m_SourceName_DataHandler = WebSocket_String_DataHandler( "Sink Name Web Socket Handler", m_WebSocketDataProcessor, true, true, m_SourceName, false );
    ...
    WebSocketDataHandler<ConnectionStatus_t, 1> m_SinkConnectionStatus_DataHandler = WebSocketDataHandler<ConnectionStatus_t, 1>( "BT Sink Connection State Web Socket Handler", m_WebSocketDataProcessor, true, true, m_SinkConnectionState, false );    
    ...
    WebSocketDataHandler<bool, 1> m_BluetoothSinkAutoReConnect_DataHandler = WebSocketDataHandler<bool, 1>( "Source Enable Web Socket Handler", m_WebSocketDataProcessor, true, true, m_BluetoothSinkAutoReConnect, false );
    ...
    WebSocketDataHandler<bool, 1> m_BluetoothSourceEnable_DataHandler = WebSocketDataHandler<bool, 1>( "Source Enable Web Socket Handler", m_WebSocketDataProcessor, true, true, m_BluetoothSourceEnable, false );
    ...
    WebSocket_Compatible_Device_DataHandler m_TargetCompatibleDevice_DataHandler = WebSocket_Compatible_Device_DataHandler("BT Target Device Web Socket Data Handler", m_WebSocketDataProcessor, true, true, m_TargetCompatibleDevice, false );
    ...
    WebSocketDataHandler<bool, 1> m_SinkConnect_DataHandler = WebSocketDataHandler<bool, 1>( "Sink Connect Web Socket Handler", m_WebSocketDataProcessor, true, true, m_SinkConnect, false );
    ...
    WebSocketDataHandler<bool, 1> m_SinkDisconnect_DataHandler = WebSocketDataHandler<bool, 1>( "Sink Disconnect Web Socket Handler", m_WebSocketDataProcessor, true, true, m_SinkDisconnect, false );
    ...
    WebSocketDataHandler<bool, 1> m_SourceConnect_DataHandler = WebSocketDataHandler<bool, 1>( "Output Source Connect Web Socket Handler", m_WebSocketDataProcessor, true, true, m_SourceConnect, false );
    ...
    WebSocketDataHandler<bool, 1> m_SourceDisconnect_DataHandler = WebSocketDataHandler<bool, 1>( "Output Source Disconnect Web Socket Handler", m_WebSocketDataProcessor, true, true, m_SourceDisconnect, false );
    ...
    WebSocket_ActiveCompatibleDevice_ArrayDataHandler m_ScannedDevice_DataHandler = WebSocket_ActiveCompatibleDevice_ArrayDataHandler( "Scan BT Device Web Socket Data Handler", m_WebSocketDataProcessor, true, true, m_ScannedDevice, false );
    ...
    WebSocketDataHandler<bool, 1> m_BluetoothSourceAutoReConnect_DataHandler = WebSocketDataHandler<bool, 1>( "Bluetooth Source Auto Reconnect Web Socket Handler", m_WebSocketDataProcessor, true, true, m_BluetoothSourceAutoReConnect, false );
    ...
    WebSocketDataHandler<ConnectionStatus_t, 1> m_SourceConnectionState_DataHandler = WebSocketDataHandler<ConnectionStatus_t, 1>( "Source Connection State Web Socket Handler", m_WebSocketDataProcessor, true, true, m_SourceConnectionState, false );    
    ...
    WebSocketDataHandler<bool, 1> m_SourceReset_DataHandler = WebSocketDataHandler<bool, 1>( "Source Reset Web Socket Handler", m_WebSocketDataProcessor, true, true, m_SourceReset, false );    
    ...
    bool HandleSignalValue(JSONVar &jsonObject)
    {
      ...
      if(jsonObject.hasOwnProperty("SignalValue"))
      {
        ...
        if (signalValue.hasOwnProperty("Id") && signalValue.hasOwnProperty("Value"))
        {
          ...
          ESP_LOGI( "SettingsWebServer: HandleWebSocketMessage", "Signal Value Message Received. ID: \"%s\" Value: \"%s\""
                  , Id.c_str()
                  , Value.c_str() );
