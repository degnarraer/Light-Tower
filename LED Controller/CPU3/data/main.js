...
export const Source_Discovery_Mode = new Model_DiscoveryMode('Src_Discov_Mode', 'Src_Start_Scan', 'Src_Stop_Scan', Model_DiscoveryMode.values.Discovery_Mode_Unknown, wsManager);
