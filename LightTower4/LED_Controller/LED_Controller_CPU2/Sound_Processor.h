                     ...
                     , public QueueManager
{
  ...
  private:
    ...
    void AssignToBins(double* Band_Data, double* FFT_Data, int16_t FFT_Size);
    ...
    DataItemConfig_t m_ItemConfig[m_ConfigCount]
    {
      ...
      { "R_FFT_IN",         DataType_Int32_t,   I2S_SAMPLE_COUNT,   Transciever_RX,   5 },
      { "L_FFT_IN",         DataType_Int32_t,   I2S_SAMPLE_COUNT,   Transciever_RX,   5 },
    };
};
