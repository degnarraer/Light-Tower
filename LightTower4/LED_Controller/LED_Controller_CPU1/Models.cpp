...
MaxBandSoundData_t StatisticalEngineModelInterface::GetMaxBandSoundData(){ return m_StatisticalEngine.GetMaxBandSoundData(); }
MaxBandSoundData_t StatisticalEngineModelInterface::GetMaxBinRightSoundData(){ return m_StatisticalEngine.GetMaxBinRightSoundData(); }
MaxBandSoundData_t StatisticalEngineModelInterface::GetMaxBinLeftSoundData(){ return m_StatisticalEngine.GetMaxBinLeftSoundData(); }
void Model::Setup()
{
  SetupModel();
}
