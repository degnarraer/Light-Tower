...
#define SOUND_PROCESSOR_INPUT_COMPLETE_DATA_R_DEBUG true
#define SOUND_PROCESSOR_INPUT_COMPLETE_DATA_L_DEBUG false
#define SOUND_PROCESSOR_OUTPUTDATA_R_DEBUG true
...
#define SOUND_PROCESSOR_OUTPUT_WIDTH 15
