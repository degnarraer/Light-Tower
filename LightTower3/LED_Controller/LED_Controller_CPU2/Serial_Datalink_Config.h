                       ...
                       , public QueueManager
{
  ...
  private:
    ...
    DataItemConfig_t m_ItemConfig[m_SPIDatalinkConfigCount]
    {
      ...
      { "Processed_Frame",  DataType_ProcessedSoundFrame_t,  1,                  Transciever_TX,   10 },
      { "R_MAXBAND",        DataType_MaxBandSoundData_t,     1,                  Transciever_TX,   10 },
      { "L_MAXBAND",        DataType_MaxBandSoundData_t,     1,                  Transciever_TX,   10 },
