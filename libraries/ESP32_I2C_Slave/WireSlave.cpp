...
TwoWireSlave::TwoWireSlave(uint8_t bus_num)
    ...
    ,unpacker_()
{
	rxBuffer = (uint8_t *)heap_caps_malloc(I2C_BUFFER_LENGTH, MALLOC_CAP_SPIRAM);
	txBuffer = (uint8_t *)heap_caps_malloc(I2C_BUFFER_LENGTH, MALLOC_CAP_SPIRAM);
}
